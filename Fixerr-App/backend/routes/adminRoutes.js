...
router.patch('/requests/:id', auth, admin, adminController.updateBooking);
...
router.get('/admin/unassigned-bookings', adminController.getUnassignedBookings);
router.get('/admin/unassigned-bookings/:ref/candidates', adminController.getBookingCandidates);
router.post('/admin/unassigned-bookings/assign', adminController.assignProToBooking);
router.post('/admin/unassigned-bookings/bulk-assign', adminController.bulkAssignBestMatch);
router.post('/admin/unassigned-bookings/:ref/notify-customer', adminController.notifyCustomerNoProfessional);
